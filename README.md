The project relied on the following references for tasks such as importing CSV files, gathering data on technical recessions, and obtaining coding assistance for graph plotting.
